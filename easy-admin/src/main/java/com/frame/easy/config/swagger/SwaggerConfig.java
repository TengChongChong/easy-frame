package com.frame.easy.config.swagger;
...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
//                .apis(withClassAnnotation(Api.class)) // 只显示有@Api的class
                // 只显示有@ApiOperation的方法
...
//                .version("1.0")
    ...
    private static final String DEFAULT_PATH = "/auth/swagger";
    ...
    public SimpleUrlHandlerMapping swaggerUrlHandlerMapping(ServletContext servletContext,
        ...
        Map<String, ResourceHttpRequestHandler> urlMap = new HashMap<>(1);
        {
