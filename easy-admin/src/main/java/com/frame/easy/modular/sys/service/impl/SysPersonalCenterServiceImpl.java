 ...
 */
@Service
public class SysPersonalCenterServiceImpl implements SysPersonalCenterService {

    @Autowired
    private SysUserService sysUserService;

    @Override
    public String saveAvatar(String path) {
    ...
    @Override
    public boolean saveSecuritySetting(SysUserSecuritySetting securitySetting) {
        return false;
    }

    @Override
    public boolean saveSetting(SysUserSetting setting) {
        return false;
    }
}
